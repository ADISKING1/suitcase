...
public class TableTaskTest extends TestCase {
	...
	public void testCreateTable_ExpectPass() {
		...
		try {
			...
			String schemaETag = sc.getSchemaETagForTable(cloudEndpointInfo.getServerUrl(), cloudEndpointInfo.getAppId(),
					testTableId);
	...
	public void testDeleteTable_ExpectPass() {
		...
		try {
			...
			sc.createTableWithCSV(cloudEndpointInfo.getServerUrl(), cloudEndpointInfo.getAppId(), testTableId, schemaETag,
					dataPath);
			schemaETag = sc.getSchemaETagForTable(cloudEndpointInfo.getServerUrl(), cloudEndpointInfo.getAppId(),
					testTableId);
	...
	public void testClearTable_ExpectPass() {
		...
		try {
			...
			JSONObject rowsObj = sc.getRows(cloudEndpointInfo.getServerUrl(), cloudEndpointInfo.getAppId(), testTableId,
					schemaETag, null, null);
			...
			rowsObj = sc.getRows(cloudEndpointInfo.getServerUrl(), cloudEndpointInfo.getAppId(), testTableId, schemaETag,
					null, null);
